...
@Slf4j
public class SpringAIMessageHelper implements Runnable{

    String chatId;
    String message;
    SpringAIClient springAIClient;

    public SpringAIMessageHelper(String chatId, String message, SpringAIClient springAIClient) {
        this.chatId = chatId;
    ...
    private boolean askSpringAI() {
        try {
            ...
            String completeMessage = springAIClient.askSpringAISync(message,chatId);
